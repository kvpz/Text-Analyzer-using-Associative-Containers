/*
    list.cpp
    Kevin Perez / Chris Lacher
    5/17/15

   This file contains the implementation for list.h.
...
// sorts are in slave file list_sort.cpp
// other macro mutators (Merge, Reverse)
...
// link newLink into list at (ahead of) location
{
 ...
 { 
    ...
    location->prev_->next_ = newLink;
    newLink->next_ = location;
    location->prev_ = newLink;
  }
}
